...
impl ::protobuf::ProtobufEnum for WorkerShutdownMode {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<WorkerShutdownMode> {
        match value {
            ...
            1 => ::std::option::Option::Some(WorkerShutdownMode::SHUTDOWN_IMMEDIATELY),
    ...
    fn values() -> &'static [Self] {
        static values: &'static [WorkerShutdownMode] = &[
            ...
            WorkerShutdownMode::SHUTDOWN_IMMEDIATELY,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    WorkerShutdownMode\x12\x0b\n\x07DEFAULT\x10\0\x12\x18\n\x14SHUTDOWN_IMME\
    DIATELY\x10\x01\x12\x18\n\x14WAIT_FOR_COORDINATOR\x10\x02B'\n\x13org.ten\
    sorflow.utilB\x0bEventProtosP\x01\xf8\x01\x01b\x06proto3\
";
